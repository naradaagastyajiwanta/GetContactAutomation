/**
 * EmailSentView — shows all sent emails from the IMAP Sent folder.
 */
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto">
          {isLoading ? (
            ...
            <EmptyState
              icon={Send}
              title={search ? 'No emails match your search' : 'No sent emails yet'}
              description={
                search
                  ? 'Try a different search term.'
                  : 'Sent emails from this account will appear here.'
              }
            />
          ) : (
