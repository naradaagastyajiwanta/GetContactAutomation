...
import { BLAST_TOUR_STEPS } from "../tours/blast.tour";
...
export default function BlastCampaignsPage() {
  ...
  usePageTour("blast", BLAST_TOUR_STEPS);
  ...
  return (
    <div className="max-w-5xl mx-auto py-6 px-4">
      ...
      {isLoading ? (
        ...
        <div data-tour="blast-list" className="space-y-3">
          {campaigns.map((c) => (
            <CampaignCard
              key={c.id}
              campaign={c}
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 line-clamp-1 mb-2">
            {c.template_message
              ? c.template_message.substring(0, 120) +
                (c.template_message.length > 120 ? "..." : "")
              : "No template set"}
          </p>
          ...
          <div className="mt-2 flex flex-wrap gap-x-4 gap-y-1 text-[11px] text-gray-500 dark:text-gray-400">
            <span>
              Dibuat oleh {c.created_by_name || c.created_by_email || "Unknown"}
            </span>
