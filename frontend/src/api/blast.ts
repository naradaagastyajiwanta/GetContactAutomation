...
export async function deleteCampaign(id: number): Promise<{ success: boolean }> {
...
export async function getRecipients(
  ...
  const { data } = await apiClient.get(`/blast/campaigns/${campaignId}/recipients`, { params })
  return data
}
...
export async function removeRecipient(
  ...
  const { data } = await apiClient.delete(`/blast/campaigns/${campaignId}/recipients/${recipientId}`)
  return data
}
...
export async function clearRecipients(
  ...
  const { data } = await apiClient.delete(`/blast/campaigns/${campaignId}/recipients`)
  return data
}
...
export async function previewMessages(
  ...
  const { data } = await apiClient.get(`/blast/campaigns/${campaignId}/preview`, {
    params: { limit },
  })
  return data
}
...
export async function cancelCampaign(
  ...
  const { data } = await apiClient.post(`/blast/campaigns/${campaignId}/cancel`)
  return data
}
