...
async def main():
    ...
    async with async_playwright() as p:
        ...
        input('Tekan ENTER di terminal ini JIKA Anda SUDAH BERHASIL LOGIN Instagram dan melihat halaman home...')
        ...
        await browser.close()
        print('\nSelesai! Sesi cookie sosial media Anda berhasil disimpan.')
